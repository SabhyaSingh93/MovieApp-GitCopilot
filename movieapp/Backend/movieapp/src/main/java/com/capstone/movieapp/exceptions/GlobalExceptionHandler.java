...
/**
 * This class is a controller advice that handles global exceptions for the
 * NewsApp application.
 * It provides exception handling methods for specific exceptions and a generic
...
public class GlobalExceptionHandler {
     ...
     */
    @ExceptionHandler(MovielAlreadyExistsException.class)
    public ResponseEntity<String> handleMovieAlreadyExistsException(MovielAlreadyExistsException exception) {
        logger.error("MovieAlreadyExistsException occurred: {}", exception.getMessage());
        return ResponseEntity.badRequest().body(exception.getMessage());
    }

    /**
     * Handles the EmailIdAlreadyExistsException and returns a ResponseEntity with a
     * bad request status code and the exception message in the response body.
     *
     * @param exception The EmailIdAlreadyExistsException that occurred.
     * @return A ResponseEntity with a bad request status code and the exception
     ...
     * Logs the exception message and returns a ResponseEntity with a bad request
     * status
